    ...
    public class YourPlaceDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hotel>().HasData(
               new() { HotelID = 1, MainImageURL = "Arte.jpg", HotelName = "Arte Spa Hotel", Address = "ул. Юндола 20", Town = "Велинград", Country = "България", Rating = 9.7, Details = "Хотелът е с чудесен изглед към гората. Има неограничен безплатен Wi-Fi и удобен паркинг. Хотелът разполага с три вътрешни басейна и един външен.", Verified = true },
               new() { HotelID = 2, MainImageURL = "RoseGarden.jpg", HotelName = "Rose Garden", Address = "ул. Ропотамо 12", Town = "Поморие", Country = "България", Rating = 8.5, Details = "Апартаменти Роуз Гардънс се намират на 50 метра от плажа. Включват сезонен външен басейн и сезонен ресторант, безплатен Wi-Fi и сезонен спа център.", Verified = true },
               new() { HotelID = 3, MainImageURL = "Therme.jpg", HotelName = "Therme", Address = "ул. Горна Баня", Town = "Баня", Country = "България", Rating = 9.1, Details = "Хотелът предлага безплатен високоскоростен WI-FI. Има спа център и 3 вътрешни басейна, както и 2 външни - един за деца, един за възрастни.", Verified = true },
               new() { HotelID = 4, MainImageURL = "LaFleur.jpg", HotelName = "La Fleur", Address = "Flower str.", Town = "Paris", Country = "Франция", Rating = 9.5, Details = "Прекрасна гледка към Айфеловата кула. Храната е високо качество, а стаите са прекрасни.", Verified = true },
               new() { HotelID = 5, MainImageURL = "RoyalLasVegas.jpg", HotelName = "Las Vegas Royal", Address = "Monte Carlo str.", Town = "Las Vegas", Country = "САЩ", Rating = 7.9, Details = "Хотел Las Vegas Royal предлага всякакви по вид занимания - от масажи до турнири по тенис и футбол. All-Inclisuve с включена храна и напитки", Verified = true }
            );
